...
package org.wso2.maven.dsgadget.artifact.utils;
...
public class FileManagementUtils {
    ...
    private static final String DSGADGET_TEMP = "dsgadget-tmp";
    ...
    public static File createArchive(File location, File artifactLocation, String artifactName) throws Exception {
        ...
        File zipFolder = new File(gadgetDataFolder, artifactLocation.getName());
        if (!zipFolder.mkdirs()) {
            logger.error(ERROR_CREATING_CORRESPONDING_ZIP_FILE);
        }
        ;
        ...
        org.apache.commons.io.FileUtils.deleteDirectory(gadgetDataFolder);
        return zipFile;
    }
