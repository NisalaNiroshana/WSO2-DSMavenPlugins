...
package org.wso2.maven.dsgadget.artifact;
...
import org.wso2.maven.dsgadget.artifact.utils.FileManagementUtils;

import java.io.File;

@Mojo(name = "buildDSGadget") public class DSGadgetMojo extends AbstractMojo {
    ...
    private static String GADGET_CONTENT_DIR = "gadget";
    private static String SEPERATOR = "-";
    private static String FILE_TYPE_SEPERATOR = ".";

    public void execute() throws MojoExecutionException, MojoFailureException {
        File project = path;
        File gadgetContentDir = new File(project, GADGET_CONTENT_DIR);
        createZip(gadgetContentDir);
    }
    ...
    private void createZip(File project) throws MojoExecutionException {
        try {
            ...
            throw new MojoExecutionException("Error while creating gadget archive", e);
        }
