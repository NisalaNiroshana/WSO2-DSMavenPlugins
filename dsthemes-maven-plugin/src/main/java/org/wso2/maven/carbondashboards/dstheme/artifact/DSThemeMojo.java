...
package org.wso2.maven.carbondashboards.dstheme.artifact;
...
import org.wso2.maven.carbondashboards.dstheme.artifact.utils.FileManagementUtils;

import java.io.File;

@Mojo(name = "buildDSTheme") public class DSThemeMojo extends AbstractMojo {
    ...
    private static String THEME_CONTENT_DIR = "theme";
    private static String SEPERATOR = "-";
    private static String FILE_TYPE_SEPERATOR = ".";

    public void execute() throws MojoExecutionException, MojoFailureException {
        File project = path;
        File themeContentDir = new File(project, THEME_CONTENT_DIR);
        createZip(themeContentDir);
    }
    ...
    private void createZip(File project) throws MojoExecutionException {
        try {
            ...
            throw new MojoExecutionException("Error while creating theme archive", e);
        }
